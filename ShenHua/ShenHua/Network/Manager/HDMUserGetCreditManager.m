...
#import "HDMUserGetCreditManager.h"
#import "HDMNetwork.h"
#import "HDMCredit.h"
@implementation HDMUserGetCreditManager

- (void)enquiryListSuccess:(void (^)(NSDictionary *))success Failure:(void (^)(NSDictionary *))failure {
    
    [[HDMNetwork sharedInstance] query_jf_record_GET_Cur_page:BCIntegerString(self.currentPage) Page_size:BCIntegerString(self.pageSize) Success:^(NSURLSessionDataTask *task, id responseObject) {
