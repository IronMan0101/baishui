...
#import "HDMUserSetCurrencyManager.h"
#import "HDMNetwork.h"
#import "HDMCurrency.h"
@implementation HDMUserSetCurrencyManager


- (void)enquiryListSuccess:(void (^)(NSDictionary *))success Failure:(void (^)(NSDictionary *))failure {
    
    [[HDMNetwork sharedInstance] query_mb_cost_record_GET_Cur_page:BCIntegerString(self.currentPage) Page_size:BCIntegerString(self.pageSize) Success:^(NSURLSessionDataTask *task, id responseObject) {
