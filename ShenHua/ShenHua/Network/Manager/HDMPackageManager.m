...
//  Zone
//
//  Created by Sea on 14-6-10.
//
//

#import "HDMPackageManager.h"
#import "HDMNetwork.h"
#import "HDMPackage.h"

@implementation HDMPackageManager


- (void)enquiryListSuccess:(void (^)(NSDictionary *))success Failure:(void (^)(NSDictionary *))failure {
    
    [[HDMNetwork sharedInstance] query_package_bag_info_GET_Tabnum:BCIntString(self.packageBag) Success:^(NSURLSessionDataTask *task, id responseObject) {
        ...
        if (![code boolValue])
        {
            ...
            for (NSDictionary * dictionary in array)
            {
                ...
                HDMPackage * model = [[HDMPackage alloc] initWithAttributes:attributes];//修改二处
